...
TRAIN_JSON = os.path.join(
    BASE_DIR, TRAIN_SPLIT, "annotations", f"{TRAIN_SPLIT}.json"
)
VAL_JSON = os.path.join(
    BASE_DIR, VAL_SPLIT, "annotations", f"{VAL_SPLIT}.json"
)
